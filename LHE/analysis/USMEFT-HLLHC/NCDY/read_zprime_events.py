...
def build_filename(parameters: tuple):
    ...
    return f"NCDY-Zprime-beta_{coup * 10:.0f}E-01-MXX_{mass}-TeV.json"


if __name__ == "__main__":
    # Path to where the files are store
    folderpath = "/home/martines/work/MG5_aMC_v2_9_23/PhD/USMEFT-HLLHC/DY/Zprime"

    # Folders that contains the events
    folders = [f"lhe_files_{MXX}_TeV" for MXX in [4, 5, 6, 7, 8]]

    # Respective value of the coupling that was simulated in each of
    mass_coup_dict = {4: 0.5, 5: 0.8, 6: 0.8, 7: 1.0, 8: 1.0}
        ...
        5:
            {
                ...
                "beta_-8E-1": {"beta": -0.8, "MXX": 5}, "beta_-10E-1": {"beta": -1.0, "MXX": 5}
            },
        6:
            {
                ...
                "beta_-8E-1": {"beta": -0.8, "MXX": 6}, "beta_-10E-1": {"beta": -1.0, "MXX": 6},
                "beta_12E-1": {"beta": 1.2, "MXX": 6}, "beta_-12E-1": {"beta": -1.2, "MXX": 6}
            },
        7:
            {
                "rwgt_1": {"beta": 1.0, "MXX": 7}, "beta_3E-1": {"beta": 0.3, "MXX": 7},
                "beta_5E-1": {"beta": 0.5, "MXX": 7}, "beta_8E-1": {"beta": 0.8, "MXX": 7},
                "beta_12E-1": {"beta": 1.2, "MXX": 7}, "beta_15E-1": {"beta": 1.5, "MXX": 7},
                "beta_-3E-1": {"beta": -0.3, "MXX": 7}, "beta_-5E-1": {"beta": -0.5, "MXX": 7},
                "beta_-8E-1": {"beta": -0.8, "MXX": 7}, "beta_-10E-1": {"beta": -1.0, "MXX": 7},
                "beta_-12E-1": {"beta": -1.2, "MXX": 7}, "beta_-15E-1": {"beta": -1.5, "MXX": 7}
            },
        8:
            {
                "rwgt_1": {"beta": 1.0, "MXX": 8}, "beta_3E-1": {"beta": 0.3, "MXX": 8},
                "beta_5E-1": {"beta": 0.5, "MXX": 8}, "beta_8E-1": {"beta": 0.8, "MXX": 8},
                "beta_12E-1": {"beta": 1.2, "MXX": 8}, "beta_15E-1": {"beta": 1.5, "MXX": 8},
                "beta_-3E-1": {"beta": -0.3, "MXX": 8}, "beta_-5E-1": {"beta": -0.5, "MXX": 8},
                "beta_-8E-1": {"beta": -0.8, "MXX": 8}, "beta_-10E-1": {"beta": -1.0, "MXX": 8},
                "beta_-12E-1": {"beta": -1.2, "MXX": 8}, "beta_-15E-1": {"beta": -1.5, "MXX": 8}
            }
    }
    ...
    for foldername, (MXX, beta) in zip(folders, mass_coup_dict.items()):
        ...
        histograms_mxx = WeightedHistogramManager(
            bin_edges=bin_edges, observale=InvariantMassObs(part_pids=[11]), get_weights=get_weights,
    ...
    # Also the SM prediction
    with open(f"{folderpath}/../NCDY-HLLHC.json") as file_:
        eft_simulations = json.load(file_)

    # Saves each of the histogram
    for model_param, hist in histograms_model.items():
        pseudo_data = {"data": hist.tolist(), "SM": eft_simulations["SM"], "bin-edges": bin_edges}
