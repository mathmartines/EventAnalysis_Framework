...
from EventAnalysis_Framework.LHE.analysis.TGC.ATLAS_WW_1905_04242.fiducial_phase_space import fiducial_phase_space, leading_lepton_pT
...
if __name__ == "__main__":
    ...
    event_analysis = EventAnalysis(cuts=[fiducial_phase_space])

    # Performs the loop over the events
    event_loop = EventLoop(file_reader=pylhe.read_lhe, histogram=pTlead_dist)
    ...
    with open(f"{folderpath}/ATLAS_WW_1905_04242_dsig_dpTlead.json", "w") as file_:
